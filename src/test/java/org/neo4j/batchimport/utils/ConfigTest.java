...
//        final String[] args = "data/dir nodes.csv relationships.csv [node_index node-index-name fulltext|exact
// nodes_index.csv rel_index rel-index-name fulltext|exact rels_index.csv ....]".split(" ");
