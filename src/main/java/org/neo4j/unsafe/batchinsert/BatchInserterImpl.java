...
public class BatchInserterImpl implements BatchInserter
{
    ...
    protected final BatchTokenHolder propertyKeyTokens;
    protected final BatchTokenHolder relationshipTypeTokens;
    protected final BatchTokenHolder labelTokens;
    ...
    protected long createPropertyChain( Map<String, Object> properties )
    {
    ...
    protected int createNewPropertyKeyId( String stringKey )
    {
    ...
    protected int createNewRelationshipType( String name )
    {
