...
public class MapDbCachingIndexProvider implements BatchInserterIndexProvider
{
    ...
    {
        Map<String, NavigableSet<Fun.Tuple2<Object, Long>>> caches = new HashMap<String,
                NavigableSet<Fun.Tuple2<Object, Long>>>();
        private final DB db;
        ...
        private NavigableSet<Fun.Tuple2<Object, Long>> getSet( String property )
        {
            ...
            set = db.<Fun.Tuple2<Object, Long>>createTreeSet( indexName + "." + property, 32, false,
                    BTreeKeySerializer.TUPLE2, null );
